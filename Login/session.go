...
// 	var userLogin UserSession
// 	userLogin.UserID = 1
// 	userLogin.Device = "Window x64 Chrome"
// 	userLogin.Online = true
// 	at := time.Unix(12129121, 0)
// 	now := time.Now()
// 	// at := time.Unix(td.AtExpires, 0)
// 	sessionCreate := client.Set(strconv.Itoa(int(userLogin.UserID)),userLogin, at.Sub(now)).Err()
// 	if sessionCreate != nil {
// 		c.JSON(http.StatusBadGateway, "Error created session")
// 		return
// 	}
// 	val, err := client.Get(strconv.Itoa(int(userLogin.UserID))).Result()
// 	if err != nil {
// 		fmt.Println(err)
// 	}
